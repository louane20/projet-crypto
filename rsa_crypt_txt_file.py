...
def encryptAndWriteToFile(messageFilename, keyFilename, messageFile, blockSize=DEFAULT_BLOCK_SIZE):
    # Using a key from a key file, encrypt the message and save it to a
    # file. Returns the encrypted message string.
    keySize, n, e = readKeyFile(keyFilename)

    # Read in the message length and the message from the file.
    fo = open(messageFile)
    message = fo.read()
    print(message)
...
def readFromFileAndDecrypt(messageFilename, keyFilename,messageFiledecrypted):
    ...
    # create new file to make decrypt message 
    message=decryptMessage(encryptedBlocks, messageLength, (n, d), blockSize)
    fo = open(messageFiledecrypted, 'w')
    fo.write(message)
    fo.close()
...
############# pour crypté ###################
#file_txt_crypt="nour_txt_file_crypt.txt"
#keyFilename='nour_pubkey.txt'
#messageFile="nour_txtfile.txt"
#encryptAndWriteToFile(file_txt_crypt, keyFilename, messageFile)


####### pour decrypté #######################
keyFilename='nour_privkey.txt'
messageFilename='nour_txt_file_crypt.txt'
messageFiledecrypted="new_nour_txtfile.txt"
decryptedText =readFromFileAndDecrypt(messageFilename, keyFilename,messageFiledecrypted)
print(decryptedText)